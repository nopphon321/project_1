...
<section class="site-hero overlay" style="background-image: url(img/hero_2.jpg" data-stellar-background-ratio="0.5">
      <div class="container ">
        <div class="row site-hero-inner justify-content-center align-items-center">
          ...
          <br>
    <form action="books_pays.php" method="GET">
    <h2 class=" thaifont3" data-aos="fade-up ">ยืนยันการเข้าพัก</h2>
    <br>
...
<tbody>
        ...
        ."WHERE books.bkin BETWEEN '$stdate' AND '$endate' AND books.bkstatus = 4 "
