  ...
  <?php 
    ...
    ?>
                                        <tr> <form action="detailinsert.php" method="POST">
                                            ...
                                            <td> <button type="submit" class="btn btn-info btn-fill pull-right">Update Detail</button></form></td>
                                        </tr>
        <?php } ?>
                                    </tbody>
                                </table>
