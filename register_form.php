...
<html lang="en">
  <head>
    <title>ระบบจองห้องพักออนไลน์เฮือนก่ิงกะหร่า</title>
    <meta charset="utf-8">
...
<!--vendor-->
<link href="css2/back css.css" rel="stylesheet">
    <link href="scss2/button.scss" rel="stylesheet">
...
<!--endvendor-->
    ...
    <link href="https://fonts.googleapis.com/css?family=Mitr:300|Sarabun&display=swap" rel="stylesheet">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.js.map">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js.map">
...
<nav class="navbar  navbar-expand-lg navbar-dark fixed-top bg-dark " id="mainNav">
        <div class="container">
          ...
          <ul class="navbar-nav text-uppercase ml-auto ">
                  <li class="nav-item">
                    <a class="nav-link js-scroll-trigger family" href="index.php">หน้าหลัก</a>
                </li>
    ...
    <section class="section  contact-section"  style="background-color:#ffe680">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 pr-5 pt-5 bg-light family"  style=" font-size:16PX; " data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                <p ><h4 class="family text-center"> ที่อยู่โรงแรม</h4> </p>
                <div class="family text-center" > 508 หมู่ 1 ต.เปียงหลวง
                            อ.เวียงแหง <br>จ.เชียงใหม่ 50350</div>
                            <br>
                            <h4 class="family text-center"> Phone</h4>
                 <div class="family text-center">08-71815055</div>
                 <br>
                 <h4 class="family text-center"> Email</h4>
                 <div class="family text-center">info@Kingkara.com</div>
              </div>
            </div>
          </div>
        </div>
