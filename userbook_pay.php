...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
          <a class="navbar-brand js-scroll-trigger font-weight-bold  family" href="home.php"><img src="icon/navicon.png" width="40" height="40" alt="">เฮือนก่องกะหร่า</a><span class="text-white family">ยินดีต้อนรับคุณ <?php echo $row['firstname']; ?></span>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="userpay_insert.php" method="POST" class="bg-white p-md-5 p-4 mb-5 border"  enctype="multipart/form-data" >
            ...
            $days = (int)date_diff(date_create($row['bkin']), date_create($row['bkout']))->format('%R%a');
             ?>
                ...
                <div class="col-md-4 form-group">
                  ...
                  <div class="family"><?php echo $row['tpname'];?></div>
                </div>
                <div class="col-md-4 form-group">
          ...
          <div class="col-md-5 " data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              ...
              <div class="text-black font-weight-bold family" style="font-size:20px;" > หมายเลขบัญชี <span class="thai-font1b" >  <?php echo $row['tpname'];?> </span></div>
             <table class="table">
  <thead>
    <tr>
      <th scope="col" class="text-black font-weight-bold family"></th>
      <th scope="col" class="text-black font-weight-bold family">ธนาคาร</th>
      <th scope="col" class="text-black font-weight-bold family">เลขบัญชี</th>
