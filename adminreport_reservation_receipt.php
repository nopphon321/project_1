...
</style><?php include("adminheader.php"); ?>
<?php
...
<div class="content">
 <div class="container-fluid">
                            ...
                            <div class="content">
                                ...
                                <table class="table   text-center">
                                    <thead class="text-center">
                                        ...
                                        <h3>ใบเสร็จรับเงินห้องพักเฮือนกิ่งกะหร่า</h3>
  ...
  <th><?php echo number_format( $sumprice,2); ?></th>
                 ...
                 <a href="adminreport_reservation.php" id="no_print"  class="btn btn-info btn-fill pull-center">ย้อนกลับ</a>
                            </div>
                        </div>
                    </div>
